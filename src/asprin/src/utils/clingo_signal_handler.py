...
class ClingoSignalHandler:
    ...
    def __init__(self, control,
        ...
        self.trace = trace # (modified) [2023-03-27] trace option added
        self.solving = False
        self.result = None
    ...
    def do_solve(self, control, *args, **kwargs):
        with self.condition:
            with control.solve(
                # The return value depends on the parameters. 
                # If either yield_ or async_ is true, then a handle is returned. 
                # Otherwise, a SolveResult is returned.
                # on_finish Callable[[SolveResult], None]: Optional callback called once search has finished. 
                async_=True, yield_=self.trace, on_finish=self.stop, *args, **kwargs # (modified) [2023-03-27] trace option added
    ...
    def solve(self, *args, **kwargs):
        ...
        return self.result # TODO: where this is set? -> (self.stop);  is self.result a SolverHandle object?
