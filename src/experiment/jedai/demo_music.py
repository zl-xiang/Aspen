...
def area():
    d1 = pd.read_csv("../../dataset/music/50/area.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/area_dups.csv", sep=',')
    attr = ['name']
...
def artist():
    d1 = pd.read_csv("../../dataset/music/50/artist.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/artist_dups.csv", sep=',')
    attr = ['name','sort_name']
...
def artist_credit():
    d1 = pd.read_csv("../../dataset/music/50/artist_credit.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/artist_credit_dups.csv", sep=',')
    attr = ['name']
...
def label():
    d1 = pd.read_csv("../../dataset/music/50/label.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/label_dups.csv", sep=',')
    attr = ['name']
...
def medium():
    d1 = pd.read_csv("../../dataset/music/50/medium.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/medium_dups.csv", sep=',')
    attr = ['release']
...
def place():
    d1 = pd.read_csv("../../dataset/music/50/place.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/place_dups.csv", sep=',')
    attr = ['name','address']
...
def recording():
    d1 = pd.read_csv("../../dataset/music/50/recording.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/recording_dups.csv", sep=',')
    attr = ['name']
...
def release():
    d1 = pd.read_csv("../../dataset/music/50/release.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/release_dups.csv", sep=',')
    attr = ['name']
...
def release_group():
    d1 = pd.read_csv("../../dataset/music/50/release_group.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/release_group_dups.csv", sep=',')
    attr = ['name']
...
def track():
    d1 = pd.read_csv("../../dataset/music/50/track.csv", sep=',')
    gt = pd.read_csv("../../dataset/music/50/track_dups.csv", sep=',')
    attr = ['name']
