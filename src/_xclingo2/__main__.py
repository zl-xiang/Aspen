...
from _xclingo2._main import XclingoControl
...
from _xclingo2.error import ModelControlGroundingError, ModelControlParsingError
from _xclingo2.explainer.error import ExplanationControlParsingError, ExplanationControlGroundingError
...
def ground_solve_explain(args, unknown_args, programs):
    ...
    # not clear why two xclingo instances are used here?
    # is it the case 
    ...
    # get the explaination of constraints
